...
function renderLandingAction(
  ...
  const marketingOptIn = context.marketingOptIn
    ? `<label class="marketing-opt-in"><input type="checkbox" name="marketingOptIn"> <span>Email me occasional updates from this site.</span></label>`
    : "";
